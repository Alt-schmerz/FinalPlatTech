...
class AdminHomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Handle the button click to replace the fragment
        val expandButton = view.findViewById<TextView>(R.id.go_to_activities)
        expandButton.setOnClickListener {
            parentFragmentManager.beginTransaction()
                .replace(R.id.fragment_container, AdminActivityFragment())
